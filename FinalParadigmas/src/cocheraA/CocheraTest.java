...
public class CocheraTest {
    ...
    @Test public void test01NuevoPostulanteConReunionSeRegistraCorrectamente(){
        assertPostulantesYReservasAfterRegistrar(new Cochera(),1,0, new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente"));

    }

    @Test public void test02NuevoPostulanteConClaseSeRegistraCorrectamente(){
        assertPostulantesYReservasAfterRegistrar(new Cochera(),1,0, new Clase(LocalDate.of(2023,1,1), "Tengo que dar una clase"));
    }

    @Test public void test03NuevoPostulanteConUsoPersonalSeRegistraCorrectamente(){
        assertPostulantesYReservasAfterRegistrar(new Cochera(),1,0, new Personal(LocalDate.of(2023,1,1), "Uso personal"));
    }

    @Test public void test04DosPostulantesEnDistintasFechasSeRegistranCorrectamente(){
        assertPostulantesYReservasAfterRegistrar(new Cochera(),2,0, new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente"), new Reunion(LocalDate.of(2023,1,2), "Tengo reunión con cliente"));
    }

    @Test public void test05DosPostulantesEnLaMismaFechaSeRegistranCorrectamente(){
        assertPostulantesYReservasAfterRegistrar(new Cochera(),2,0, new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente"), new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente"));
    }

    @Test public void test06CocheraReservaBienCuandoHayUnPostulanteConReunionEnUnaFecha(){
        assertAfterRegistrarYCerrar(new Cochera(), 1,1,LocalDate.of(2023,1,1), new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente"));
    }

    @Test public void test07CocheraReservaBienCuandoHayUnPostulanteConClase(){
        assertAfterRegistrarYCerrar(new Cochera(), 1,1,LocalDate.of(2023,1,1), new Clase(LocalDate.of(2023,1,1), "Tengo que dar una clase"));
    }

    @Test public void test08CocheraReservaBienCuandoHayUnPostulanteConUsoPersonal(){
        assertAfterRegistrarYCerrar(new Cochera(), 1,1,LocalDate.of(2023,1,1), new Personal(LocalDate.of(2023,1,1), "Uso personal"));
    }

    @Test public void test09CocheraReservaBienCuandoHayDosPostulantesConElMismoMotivo(){
        Cochera cochera = new Cochera();
        Postulante postulante1 = new Personal(LocalDate.of(2023,1,1), "Uso personal");
        Postulante postulante2 = new Personal(LocalDate.of(2023,1,1), "Uso personal");
    ...
    @Test public void test10CocheraReservaBienCuandoHayDosCandidatosConDiferentesMotivos(){
        Cochera cochera = new Cochera();
        Postulante postulante1 = new Personal(LocalDate.of(2023,1,1), "Uso personal");
        Postulante postulante2 = new Clase(LocalDate.of(2023,1,1), "Tengo que dar una clase");
        assertAfterRegistrarYCerrar(cochera, 2,1,LocalDate.of(2023,1,1), postulante1, postulante2);
    ...
    @Test public void test04NoSePuedePostularUnaVezCerradaLaFecha(){
        Cochera cochera = new Cochera();
        Postulante postulante1 = new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente");
        Postulante postulante2 = new Reunion(LocalDate.of(2023,1,1), "Tengo reunión con cliente");
